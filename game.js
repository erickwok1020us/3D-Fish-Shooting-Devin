...
// ===== FPS ABSOLUTE WORLD-SPACE CONFIG (Variant 2 — Final) =====
...
const FPS_ELEV_CAMERA_Y = 90;       // Camera World Y
const FPS_ELEV_CAMERA_Z = -800;     // Camera World Z
const FPS_ELEV_TURRET_Y = -88;      // Turret World Y (CamY - 178)
...
// ABSOLUTE WORLD-SPACE POSITIONING (Variant 2 Final)
