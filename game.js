...
function createRmbZoomHint() {
    ...
    const el = document.createElement('div');
    el.id = 'rmb-zoom-hint';
    el.style.cssText = 'position:fixed;bottom:20px;left:50%;transform:translateX(-50%);margin-left:68px;display:flex;align-items:center;gap:8px;opacity:0;transition:opacity 0.3s ease;z-index:10001;pointer-events:none;';
