...
const FISH_ELLIPSOID_RATIOS = {
    ...
    hammerhead:  [0.50, 0.28, 0.38],
    tuna:        [0.48, 0.30, 0.30],
    dolphinfish: [0.48, 0.30, 0.30],
    barracuda:   [0.58, 0.24, 0.24],
    grouper:     [0.46, 0.36, 0.36],
    parrotfish:  [0.42, 0.34, 0.30],
    angelfish:   [0.34, 0.42, 0.22],
    lionfish:    [0.38, 0.36, 0.36],
    tang:        [0.36, 0.38, 0.24],
    sardine:     [0.48, 0.26, 0.26],
    anchovy:     [0.48, 0.26, 0.26],
    clownfish:   [0.38, 0.34, 0.26],
    damselfish:  [0.38, 0.34, 0.26],
    mantaRay:    [0.38, 0.22, 0.54],
    pufferfish:  [0.34, 0.34, 0.34],
    seahorse:    [0.24, 0.46, 0.24],
    flyingFish:  [0.48, 0.26, 0.36],
    crab:        [0.30, 0.26, 0.36],
    eel:         [0.60, 0.24, 0.24],
    turtle:      [0.38, 0.30, 0.42],
    goldfish:    [0.34, 0.34, 0.26],
